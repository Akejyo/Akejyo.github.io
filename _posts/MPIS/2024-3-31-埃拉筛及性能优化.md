...
> _鲲鹏通用计算增强型 | 2vCPUs | 4GiB | kc1.large.2_ > _Ubuntu 18.04 server 64bit with ARM(40GiB)_
...
![base.drawio](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/base.drawio.png)

##### `base.cpp` 程序运行结果：

![image-20240413164307574](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240413164307574.png)
...
![image-20240410215619579](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240410215619579.png)
...
![optimize2.drawio](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/optimize2.drawio.png)

##### `optimize2.cpp` 运行结果：

![image-20240410220642233](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240410220642233.png)
...
- 首先需要知道 cache size，输入以下指令
  `lscpu`
  <img src="https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240410205109860.png" alt="image-20240410205109860" style="zoom:50%;" />
...
![optimize3.drawio](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/optimize3.drawio.png)

##### `optimize3.cpp` 运行结果：

![image-20240410221623507](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240410221623507.png)
...
1. ##### 使用 `memset` 替换 `for` 循环初始化 `marked` 数组
   ...
   ![dc4721d782bc911cf3e24a337d6f58a6](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/dc4721d782bc911cf3e24a337d6f58a6.png)
...
2. ##### 循环展开
   ...
   ![image-20240402154047317](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240402154047317.png)
   ...
   → $6.1$s
   ![image-20240402154105846](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240402154105846.png)
   ...
   ![image-20240402160221087](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240402160221087.png)
...
3. ##### 使用 `__builtin_popcountll` 函数来统计
   ...
   ![image-20240402162135210](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240402162135210.png)
...
4. ##### 继续减少标记 `marked` 数组部分的分支判断
   ...
   → $3.5$s
   ![image-20240402172417133](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240402172417133.png)
...
5. ##### 增加标记 `marked` 数组的循环展开常数
   ...
   ![image-20240402173556126](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240402173556126.png)
...
7. ##### 使用 `register` 关键字 & 内联汇编
   ...
   ![image-20240411010351955](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240411010351955.png)
   ...
   速度稍微快了点，到 $2.7$s
   ![image-20240411172818706](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240411172818706.png)
...
![image-20240411174556734](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240411174556734.png)
...
![image-20240411174500150](https://raw.githubusercontent.com/Akejyo/imageForBlog/master/img/image-20240411174500150.png)
